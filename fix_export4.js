...
// 3. tabDefs
const tabDefsRegex = /const tabDefs = \[[^\]]+\];\s*const courseCode/;
...
content = content.replace(tabDefsRegex, newTabDefs);

// 4. panels
const panelsRegex = /\/\/\s*Panel 0: Cover Page.*?const htmlContent = `/s;
