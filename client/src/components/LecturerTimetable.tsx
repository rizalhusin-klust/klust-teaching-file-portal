...
export default function LecturerTimetable({ courseInfo, onRefresh, API_BASE, activeCourseId, programName = 'Bachelor of Science (Architectural Studies)', hidePrintHeader = false }: LecturerTimetableProps) {
  ...
  return (
      <div className="view-card" style={{ padding: '20px 15px' }}>
        {!hidePrintHeader && (
          <PrintHeader title="Time-Table of Lecturer" courseInfo={courseInfo} programName={programName} />
        )}
        ...
        <div className="print-link-only" style={{ marginBottom: '20px' }}>
          <h3 style={{ fontSize: '1.2rem', marginBottom: '10px', color: '#000', borderBottom: '1px solid #ccc', paddingBottom: '4px' }}>
            Time-Table of Lecturer Summary
          </h3>
        ...
        <h2 className="no-print" style={{ fontSize: '1.4rem', marginBottom: '8px' }}>
          Time-Table of Lecturer
        </h2>
        <p className="no-print" style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '24px' }}>
          Upload the Lecturer's Timetable Schedule as a PDF/Image, or provide a direct link. This will be automatically embedded in the exported document.
        </p>
