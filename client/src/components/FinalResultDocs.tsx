...
export default function FinalResultDocs({ courseInfo, onRefresh, API_BASE, activeCourseId, programName = 'Bachelor of Science (Architectural Studies)', hidePrintHeader = false }: FinalResultDocsProps) {
  ...
  return (
      <div className="view-card" style={{ padding: '20px 15px' }}>
        {!hidePrintHeader && (
          <PrintHeader title="Detail of Result (LMS)" courseInfo={courseInfo} programName={programName} />
        )}
        ...
        <h2 className="no-print" style={{ fontSize: '1.4rem', marginBottom: '8px' }}>
          Detail of Result (LMS)
        </h2>
        <p className="no-print" style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '24px' }}>
          Upload the Detail of Result (LMS) as a PDF/Image, or provide a direct link. This will be automatically embedded in the exported document.
        </p>
