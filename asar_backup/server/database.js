...
function seedData() {
  ...
  db.run("ALTER TABLE weekly_reports ADD COLUMN session2_date_label TEXT", () => {});
  db.run("ALTER TABLE weekly_reports ADD COLUMN session2_topics TEXT", () => {});
  db.run("ALTER TABLE weekly_reports ADD COLUMN session2_syllabus_topic TEXT", () => {});
}
